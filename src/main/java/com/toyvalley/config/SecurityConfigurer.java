...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .authorizeRequests().antMatchers("/toy-exchange/user/*", "/users/*", "/users", "toys/user/*", "/toys/*", "/authenticate","/users/top-traders", "/toys/city/*", "/toys/category/*", "/toys/*", "/toys/user/*", "/categories", "/categories/*", "/toys/gender/*", "toys/condition/*", "/cities", "/cities/*", "/login", "toys/search/*").permitAll()
